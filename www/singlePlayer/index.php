	...
	if (xhttp.readyState == 4 && xhttp.status == 200) 
	{
		if(xhttp.responseText == true)
		{
			window.setInterval(function(){
				...
				{
					drawPassiveRect(canvas.width/15, canvas.height/5, canvas.width/3, canvas.height/9, [75, 75, 255, 1]);
				}
				if(mouseOver(canvas.width/15, 7*canvas.height/20, canvas.width/3, canvas.height/9))
				{
					drawPassiveRect(canvas.width/15, 7*canvas.height/20, canvas.width/3, canvas.height/9, [75, 75, 255, 1]);
				}
				if(mouseOver(canvas.width/15, 10*canvas.height/20, canvas.width/3, canvas.height/9))
				{
					drawPassiveRect(canvas.width/15, 10*canvas.height/20, canvas.width/3, canvas.height/9, [75, 75, 255, 1]);
				}
				...
				drawText(canvas.width/10, canvas.height/30, 4*canvas.width/5, canvas.height/9, "SinglePlayer", "ludificioEngine/text/fonts/8-bit/black/");
				drawText(canvas.width/15, canvas.height/5, canvas.width/3, canvas.height/9, "Magnetic", "ludificioEngine/text/fonts/8-bit/black/");
				drawText(canvas.width/15, 7*canvas.height/20, canvas.width/3, canvas.height/9, "Darkness", "ludificioEngine/text/fonts/8-bit/black/");
				...
				{ 
					window.location = windowDirectory.replace("singlePlayer/", "")+"home.php";
				}
				if(onRectButton(canvas.width/15, canvas.height/5, canvas.width/3, canvas.height/9))
				{
					window.location = windowDirectory+"Magnetic/";
				}
				if(onRectButton(canvas.width/15, 7*canvas.height/20, canvas.width/3, canvas.height/9))
				{
					window.location = windowDirectory+"Darkness/";
				}
				if(onRectButton(canvas.width/15, 10*canvas.height/20, canvas.width/3, canvas.height/9))
				{
					window.location = windowDirectory+"Daedalus/";
				}
